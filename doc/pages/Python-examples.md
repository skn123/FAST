...
|[GPU image processing with OpenCL in Python](@ref python_process_object_opencl.py)| @image html images/examples/python/python_process_object_opencl.jpg width=350px; |
|[GPU image processing and buffers with OpenCL in Python](@ref python_opencl_lookup_table.py)| @image html images/examples/python/python_opencl_lookup_table.jpg width=350px; |
