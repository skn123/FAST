...
ExternalProject_Add(openslide
        ...
        URL "https://github.com/openslide/openslide-bin/releases/download/v4.0.1.2/openslide-bin-4.0.1.2-windows-x64.zip"
...
ExternalProject_Add(openslide
        PREFIX ${FAST_EXTERNAL_BUILD_DIR}/openslide
        BINARY_DIR ${FAST_EXTERNAL_BUILD_DIR}/openslide
        URL "https://github.com/openslide/openslide-bin/releases/download/v4.0.1.2/openslide-bin-4.0.1.2-macos-arm64-x86_64.tar.xz"
        CONFIGURE_COMMAND ${CMAKE_COMMAND} -E copy_directory ${FAST_EXTERNAL_BUILD_DIR}/openslide/src/openslide/ ${FAST_EXTERNAL_INSTALL_DIR}
        BUILD_COMMAND ""
        INSTALL_COMMAND ""
)
